	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			Instructor instructor = new Instructor("Madhu", "Patel", "madhu.patel@oracle.com");
			InstructorDetails instructorDetail = new InstructorDetails("http://www.udemy.com/madhu.patel", "GuitarInstructor instructor = new Instructor(\"Ashish\", \"Singh\", \"ashish.bh.singh@oracle.com\");\n" + 
					"			InstructorDetails instructorDetail = new InstructorDetails(\"http://www.udemy.com/ashishbsingh\", \"Luv 2 code!!!!\");\n" + 
					"			instructor.setInstructorDetails(instructorDetail);");
			instructor.setInstructorDetails(instructorDetail);
